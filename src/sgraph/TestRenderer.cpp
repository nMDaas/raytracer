...
TestRenderer::TestRenderer(stack<glm::mat4>& mv, map<string,util::ObjectInstance *>& os, util::ShaderLocationsVault& shaderLocs) 
...
TestRenderer::TestRenderer (TestRenderer &t) : AbstractRenderer(t.modelview), objects(t.objects), shaderLocations(t.shaderLocations) {
