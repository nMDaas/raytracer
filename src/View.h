...
private:
    ...
    glm::vec4 getColor(HitRecord hitRecord, vector<util::Light> sceneLights, vector<vector<util::Light>> sceneLightCellCollections, IScenegraph* scenegraph); // RGB values are between 0 and 1
